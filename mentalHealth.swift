    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                Text("Mental health is crucial, and raising awareness about anxiety and depression is vital. Going through mental health issues is very common, with around 1 in 5 adults suffering a mental illness. Coping mechanisms like journaling offer an effective way to manage mental well-being. Journaling allows for self-expression, self-reflection, and tracking emotional patterns. By incorporating journaling into daily routines, individuals can enhance resilience and gain valuable insights into their mental health.")
                    .fontWeight(.semibold)
